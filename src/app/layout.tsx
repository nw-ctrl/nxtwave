...
export const metadata: Metadata = {
  ...
  keywords: 'AI services, business automation, content generation, data analysis, Australia',
};
  ...
  return (
    <footer className="bg-zinc-900 border-t border-white/10 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-5 border-t border-white/10 text-white/50 text-xs font-normal">
